...
/* Exit Reasons */
#define XTIER_EXIT_REASON_DEBUG 1111
#define XTIER_EXIT_REASON_INJECT_FINISHED 1341
#define XTIER_EXIT_REASON_INJECT_COMMAND 1342
#define XTIER_EXIT_REASON_INJECT_FAULT 1343
